...
/**
 * <p>
 * Clase Java para user_t complex type.
 *
 * <p>
...
public class UserT {
    ...
    public String toString() {
        return "User [now=" + now + ", login=" + login + ", company="
                + company + ", authString=" + authString + "]";
    }
